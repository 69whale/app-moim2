...
<body>
	<div class="root">
		...
		<form action="${joinTo }" method="post" class="join-form">
			...
			<div class="block">
				<label>사용할 아이디</label><input type="text" placeholder="영문+숫자 조합만 가능"
					name="id" />
			</div>
			<div class="block">
				<label>사용할 비밀번호</label><input type="password"
					placeholder="4글자 이상만 가능" name="pass" />
			</div>
			<div class="block">
			...
			<div class="block">
				...
				<div style="display: flex; gap: 20px">
					<c:forEach items="${avatars }" var="at" varStatus="status">
						<div style="display: flex; flex-direction: column;">
							<label for="${status.count }"> <img src="${at.url }"
								style="width: 96px" />
							</label> <input type="radio" value="${at.id }" name="avatar"
